...
export default async (req: Request, context: Context) => {
    ...
    try {
        ...
        let supporting: CitationItem[] = [];
        let contradicting: CitationItem[] = [];
        let mentioning: CitationItem[] = [];
        ...
        try {
            ...
            citationsList.forEach((cit: any) => {
                ...
                contexts.forEach((ctx: string) => {
                    ...
                    const isContradict = intents.includes("contradiction") || 
                    ...
                    const isSupport = intents.includes("support") ||
